		...
		window: {
			...
			open: {
				...
				editor: {
					...
					path: {
						// 路径
						index: '/appearance/themes/CItyInDark/app_module/editor/', // 编辑器路径
						temp: {
							// 临时文件路径
									...
									tasks: [
										{
											type: 'attr-switch',
											params: {
												'custom-writing-mode': ['vertical-rl', 'vertical-lr', 'sideways-rl', 'sideways-lr', null],
											},
										},
									],
								},
									...
									tasks: [
										{
											type: 'attr-switch',
											params: {
												'custom-auto-num-f': ['图', '图片', 'Fig.', 'figure', 'Figure', 'FIGURE', null],
											},
										},
									],
								},
									...
									tasks: [
										{
											type: 'attr-switch',
											params: {
												'custom-auto-num-t': ['表', '表格', 'Tab.', 'table', 'Table', 'TABLE', null],
											},
										},
									],
								},
