                    ...
                    async clickDay(t) {
                        ...
                        if (this.DateLinkToNote[o])
                            ...
                            if (0 === i.code && i.data) {
                                let t = i.data;
                                try {
                                    window.open("siyuan://blocks/" + t);
                                    let e = "",
                                        o = await this.request("/api/system/getConf");
                                    if ((o && o.data.conf.system.workspaceDir ? (e = o.data.conf.system.workspaceDir.replace(/\\/g, "/")) : console.error("获取工作空间目录失败，请手动设置"), 0 === n.code && n.data && n.data.conf)) {
                                        let o = n.data.conf,
                                            a = "";
...
//# sourceMappingURL=app.987de072.js.map