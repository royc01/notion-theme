...
function init() {
    ...
    settingBtn.insertAdjacentHTML(
      "afterend",
      '<div id="myHistory" style="position:absolute;z-index:100;top:30em;left:21em;width:30em;height:52.8em;background-color: var(--b3-theme-background);box-shadow: rgba(15, 15, 15, 0.05) 0px 0px 0px 1px, rgba(15, 15, 15, 0.1) 0px 3px 6px, rgba(15, 15, 15, 0.2) 0px 9px 24px; border-radius: 5px; visibility:hidden;transform: translate(-50%, -50%);overflow:auto;padding:0px 25px 10px 25px;"><div style="position:sticky;top:0px;padding-top:20px;margin-top:-2px;padding-bottom:15px; background-color:var(--b3-theme-background);" class="topBar"><input id="history_input"style="margin-left:5px; border:1px solid black ;" type="text" placeholder="搜索历史记录"  size="30"><button id = "showAllHistory"  style="margin-left:5px;">显示全部</button><button id = "clearHistory"  style="position:absolute;right:10px;top:26px;">清除历史</button></div><div id ="historyContainer"></div></div>'
    );
